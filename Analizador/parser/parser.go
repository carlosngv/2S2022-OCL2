...
const (
	...
	ParserRULE_if_instr         = 9
	ParserRULE_listaelseif      = 10
	ParserRULE_else_if          = 11
	ParserRULE_consola          = 12
	ParserRULE_llamada          = 13
	ParserRULE_listaExpresiones = 14
	ParserRULE_declaracionIni   = 15
	ParserRULE_declaracion      = 16
	ParserRULE_retorno          = 17
	ParserRULE_listides         = 18
	ParserRULE_tiposvars        = 19
	ParserRULE_expression       = 20
	ParserRULE_expr_rel         = 21
	ParserRULE_expr_arit        = 22
	ParserRULE_expr_valor       = 23
	ParserRULE_primitivo        = 24
)
...
func (s *FuncmainContext) STATIC() antlr.TerminalNode {
	return s.GetToken(ParserSTATIC, 0)
}
...
func (s *FuncmainContext) STRINGARGS() antlr.TerminalNode {
	return s.GetToken(ParserSTRINGARGS, 0)
}

func (s *FuncmainContext) ARGS() antlr.TerminalNode {
	return s.GetToken(ParserARGS, 0)
}
...
func (p *Parser) Instrucciones() (localctx IInstruccionesContext) {
	...
	for ok := true; ok; ok = (((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<ParserIF_TOK)|(1<<ParserRETURN_P)|(1<<ParserINTTYPE)|(1<<ParserFLOATTYPE)|(1<<ParserSTRINGTYPE)|(1<<ParserVOIDTYPE)|(1<<ParserSYSTEM)|(1<<ParserBOOLTYPE))) != 0) || _la == ParserID {
		{
			p.SetState(134)
...
func (p *Parser) If_instr() (localctx IIf_instrContext) {
	...
	p.EnterRule(localctx, 18, ParserRULE_if_instr)
...
func (p *Parser) Listaelseif() (localctx IListaelseifContext) {
	...
	p.EnterRule(localctx, 20, ParserRULE_listaelseif)
...
func (p *Parser) Else_if() (localctx IElse_ifContext) {
	...
	p.EnterRule(localctx, 22, ParserRULE_else_if)
...
func (p *Parser) Consola() (localctx IConsolaContext) {
	...
	p.EnterRule(localctx, 24, ParserRULE_consola)
...
func (p *Parser) Llamada() (localctx ILlamadaContext) {
	...
	p.EnterRule(localctx, 26, ParserRULE_llamada)
...
func (p *Parser) listaExpresiones(_p int) (localctx IListaExpresionesContext) {
	...
	var _ antlr.ParserRuleContext = _prevctx // TODO: To prevent unused variable warning.
	_startState := 28
	p.EnterRecursionRule(localctx, 28, ParserRULE_listaExpresiones, _p)
...
func (p *Parser) DeclaracionIni() (localctx IDeclaracionIniContext) {
	...
	p.EnterRule(localctx, 30, ParserRULE_declaracionIni)
	...
	localctx.(*DeclaracionIniContext).instr = instrucciones.NuevaDeclaracionInicializacion(localctx.(*DeclaracionIniContext).Get_listides().GetLista(), localctx.(*DeclaracionIniContext).Get_tiposvars().GetTipo(), localctx.(*DeclaracionIniContext).Get_expression().GetExpr())
...
func (p *Parser) Declaracion() (localctx IDeclaracionContext) {
	...
	p.EnterRule(localctx, 32, ParserRULE_declaracion)
...
func (p *Parser) Retorno() (localctx IRetornoContext) {
	...
	p.EnterRule(localctx, 34, ParserRULE_retorno)
...
func (p *Parser) listides(_p int) (localctx IListidesContext) {
	...
	var _ antlr.ParserRuleContext = _prevctx // TODO: To prevent unused variable warning.
	_startState := 36
	p.EnterRecursionRule(localctx, 36, ParserRULE_listides, _p)
...
func (p *Parser) Tiposvars() (localctx ITiposvarsContext) {
	...
	p.EnterRule(localctx, 38, ParserRULE_tiposvars)
...
func (p *Parser) Expression() (localctx IExpressionContext) {
	...
	p.EnterRule(localctx, 40, ParserRULE_expression)
...
func (p *Parser) expr_rel(_p int) (localctx IExpr_relContext) {
	...
	var _ antlr.ParserRuleContext = _prevctx // TODO: To prevent unused variable warning.
	_startState := 42
	p.EnterRecursionRule(localctx, 42, ParserRULE_expr_rel, _p)
	var _la int
	...
	for _alt != 2 && _alt != antlr.ATNInvalidAltNumber {
		if _alt == 1 {
			...
			}
			{
				...
				if !(((_la-33)&-(0x1f+1)) == 0 && ((1<<uint((_la-33)))&((1<<(ParserMAYORIGUAL-33))|(1<<(ParserMENORIGUAL-33))|(1<<(ParserMAYOR-33))|(1<<(ParserMENOR-33)))) != 0) {
...
func (p *Parser) expr_arit(_p int) (localctx IExpr_aritContext) {
	...
	var _ antlr.ParserRuleContext = _prevctx // TODO: To prevent unused variable warning.
	_startState := 44
	p.EnterRecursionRule(localctx, 44, ParserRULE_expr_arit, _p)
	var _la int
...
func (p *Parser) Expr_valor() (localctx IExpr_valorContext) {
	...
	p.EnterRule(localctx, 46, ParserRULE_expr_valor)
...
func (p *Parser) Primitivo() (localctx IPrimitivoContext) {
	...
	p.EnterRule(localctx, 48, ParserRULE_primitivo)
